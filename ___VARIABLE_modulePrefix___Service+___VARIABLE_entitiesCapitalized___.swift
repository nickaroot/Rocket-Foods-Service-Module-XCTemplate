...
extension ___VARIABLE_modulePrefix___Service {
    public func all___VARIABLE_entitiesCapitalized___() -> [Model] {
        ...
        let objects = realm.objects(Model.ManagedObject.self).sortedByPersistOrder
    ...
    public func ___VARIABLE_entitiesLowercased___Count() -> Int {
        ...
        return realm.objects(Model.ManagedObject.self).count
    }
    ...
    public func ___VARIABLE_entityLowercased___(modelAtIndex index: Int) -> Model? {
        ...
        guard index < realm.objects(Model.ManagedObject.self).count else { return nil }
        
        let object = realm.objects(Model.ManagedObject.self).sortedByPersistOrder[index]
